...
from core.vgg import vgg19
class VGGFeatures(torch.nn.Module):
    '''
      vgg features used for vgg-based style loss
    '''

    def __init__(self):
        torch.nn.Module.__init__(self)

        vgg_pretrained_features = vgg19(pretrained=True, init_weights=False).features
    ...
    def forward(self, x, feature_index=None):
        ...
        feats = [h_relu1_1, h_relu2_1, h_relu3_1, h_relu4_1, h_relu5_1]
